...
//		String sql = "select a.issuenumber,a.subcode,b.barcode,b.descr,b.price,SUM(a.qtyallocated) qtyallocated,(select SUM(qtyfree) from JiaoCaiInventory_detail c where a.issuenumber=c.issuenumber and a.subcode=c.subcode) qtyfree  from JiaoCaiDistribute a,JiaoCaiSku b where a.issuenumber = b.issuenumber and a.subcode = b.subcode and a.status = 0";
		String sql = "select a.issuenumber,a.subcode,b.barcode,b.descr,b.price,SUM(a.qtyallocated) qtyallocated, c.qtyfree  from JiaoCaiDistribute a,JiaoCaiSku b,(select issuenumber,subcode,SUM(qtyfree) qtyfree from JiaoCaiInventory_detail where qtyfree > 0 group by issuenumber,subcode ) c where a.issuenumber = b.issuenumber and a.subcode = b.subcode and a.issuenumber = c.issuenumber and a.subcode = c.subcode and a.status = 0 ";
		String sqladd = "";
		...
		sql += " group by a.issuenumber,a.subcode,b.barcode,b.descr,b.price,c.qtyfree";
