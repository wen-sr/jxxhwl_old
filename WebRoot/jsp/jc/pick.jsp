...
<html>
  ...
  <body>
	 ...
	 %>
  	<input type="hidden" id="pick" name='pick' value="<%=ss %>" />
  	<div id="d">
  			...
  			success:function(data){
  				if(data){
        			...
        			var dt = year + "-" + month + "-" + strDate ;
  					...
  					html += "<br/><br/><br/><br/>"
  					var sumqty = 0; 
  					html += "<table frame=hsides width='90%' rules='rows' align='center' padding-top=50px><tr><td>拣货流水号</td><td>客户代码</td><td>客户名称</td><td>配发数量</td><td>捆扎</td></tr>";
